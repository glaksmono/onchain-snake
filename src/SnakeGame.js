...
const web3 = new Web3("https://polygon-mumbai.g.alchemy.com/v2/BXORyTKyk4WoA6MCH1fx6Q1BRHFN6KHt");
const blockNumber = web3.eth.getBlockNumber();
blockNumber.then((value) => {
    console.log("The latest block number is " + value);
});

// the size of the grid is 8x8
var grid = 8;
var count = 0;
